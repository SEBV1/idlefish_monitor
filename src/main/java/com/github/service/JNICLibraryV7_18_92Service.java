 ...
 */
@Slf4j
public class JNICLibraryV7_18_92Service extends AbstractJni implements IOResolver<AndroidFileIO> {
    private final AndroidEmulator emulator;
    private final DvmClass JNICLibrary;
    private final VM vm;
    private final Boolean DEBUG_FLAG;

    private static JNICLibraryV7_18_92Service jnicLibraryV7_18_92 = null;

//    public static synchronized JNICLibraryV7_18_92Service getInstance() {
//        if (jnicLibraryV7_18_92 == null) {
//            jnicLibraryV7_18_92 = new JNICLibraryV7_18_92Service();
//            jnicLibraryV7_18_92.init();
//        }
//        return jnicLibraryV7_18_92;
//    }

//    public JNICLibraryV7_18_92Service() {
...
//    }
    ...
    public JNICLibraryV7_18_92Service(UnidbgProperties unidbgProperties) {
    ...
    public String doCommandNative_20102(String currentTimeMillis, String appKey) {
        ...
        log.info("doCommandNative_20102_result:{}", result);
        return result;
    }
    ...
    public Map<String, String> doCommandNative_70102(String appKey, String input, String api) {
        ...
        return (Map) JNICLibrary.callStaticJniMethodObject(emulator,
    ...
    private void doCommandNative_10101() {
        ...
        log.info("doCommandNative_10101_result:{}", result);
    }
    ...
    private void doCommandNative_10102() {
        ...
        String doCommandNative_10102_main_result = JNICLibrary.callStaticJniMethodObject(emulator,
            "doCommandNative(I[Ljava/lang/Object;)Ljava/lang/Object;", 10102, arrayObject).getValue().toString();
        log.info("doCommandNative_10102_main_result:{}", doCommandNative_10102_main_result);
        ...
        String doCommandNative_10102_securitybody_result = JNICLibrary.callStaticJniMethodObject(emulator,
            "doCommandNative(I[Ljava/lang/Object;)Ljava/lang/Object;", 10102, arrayObject).getValue().toString();
        log.info("doCommandNative_10102_securitybody_result:{}", doCommandNative_10102_securitybody_result);
        ...
        String doCommandNative_10102_middletier_result = JNICLibrary.callStaticJniMethodObject(emulator,
            "doCommandNative(I[Ljava/lang/Object;)Ljava/lang/Object;", 10102, arrayObject).getValue().toString();
        log.info("doCommandNative_10102_middletier_result:{}", doCommandNative_10102_middletier_result);
    }
